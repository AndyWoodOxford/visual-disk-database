...
CALL disks.create_disk('Airplane!', 'Airplane', 'Jim Abrahams, David Zucker, Jerry Zucker', 1980, 0, 1, 'Film', 'PG', 'DVD');
CALL disks.create_disk('Airplane II: The Sequel', 'Airplane II: The Sequel', 'Ken Finkleman', 1982, 0, 1, 'Film', '15', 'DVD');
CALL disks.create_disk('American Beauty', 'American Beauty', 'Sam Mendes', 2000, 0, 1, 'Film', '18', 'DVD');
CALL disks.create_disk('American Psycho', 'American Psycho', 'Mary Harron', 2000, 0, 1, 'Film', '18', 'DVD');
CALL disks.create_disk('Austin Powers: International Man of Mystery', 'Austin Powers - 1. International Man of Mystery', 'Jay Roach', 1997, 0, 1, 'Film', '15', 'DVD');
CALL disks.create_disk('Austin Powers: The Spy Who Shagged Me', 'Austin Powers - 2. The Spy Who Shagged Me', 'Jay Roach', 1999, 0, 1, 'Film', '12', 'DVD');
CALL disks.create_disk('Austin Powers in Goldmember', 'Austin Powers - 3. Goldmember', 'Jay Roach', 2002, 0, 1, 'Film', '12', 'DVD');
...
CALL disks.create_disk('Beavis and Butt-Head Do America', 'Beavis and Butt-Head Do America', 'Mike Judge', 1996, 0, 1, 'Film', '12', 'DVD');
CALL disks.create_disk('The Complete Blackadder - All Four Series', 'Blackadder Boxed Set (Series 1-4)', 'Martin Shardlow, Mandie Fletcher, Richard Boden', 2001, 0, 4, 'TV Series', '15', 'DVD');
CALL disks.create_disk('The Bourne Identity', 'Bourne Identity', 'Doug Liman', 2002, 0, 1, 'Film', '12', 'DVD');
CALL disks.create_disk('The Bourne Supremacy', 'Bourne Supremacy', 'Paul Greengrass', 2004, 0, 1, 'Film', '12', 'DVD');
CALL disks.create_disk('The Bourne Ultimatum', 'Bourne Ultimatum', 'Paul Greengrass', 2007, 0, 1, 'Film', '12', 'DVD');
CALL disks.create_disk('Bridget Jones’s Diary', 'Bridget Jones’s Diary', 'Sharon Maguire', 2001, 0, 1, 'Film', '15', 'DVD');
CALL disks.create_disk('A Bug’s Life', 'Bug’s Life', 'John Lasseter', 1998, 0, 1, 'Film', 'U', 'DVD');
CALL disks.create_disk('Chocolat', 'Chocolat', 'Lasse Hallström', 2000, 0, 1, 'Film', '12', 'DVD');
CALL disks.create_disk('A Clockwork Orange', 'Clockwork Orange', 'Stanley Kubrick', 1971, 0, 1, 'Film', '18', 'DVD');
CALL disks.create_disk('Terry Pratchett''s Colour of Magic', 'Colour of Magic', 'Vadim Jean', 2008, 0, 1, 'TV Adaptation', 'PG', 'DVD');
CALL disks.create_disk('Crouching Tiger, Hidden Dragon', 'Crouching Tiger, Hidden Dragon', 'Ang Lee', 2000, 0, 1, 'Film', '12', 'DVD');
CALL disks.create_disk('The Da Vinci Code', 'Da Vinci Code', 'Ron Howard', 2006, 0, 2, 'Film', '12', 'DVD');
CALL disks.create_disk('The Day After Tomorrow', 'Day After Tomorrow', 'Roland Emmerich', 2004, 0, 1, 'Film', '12', 'DVD');
CALL disks.create_disk('The Day of the Jackal', 'Day of the Jackal', 'Fred Zinnemann', 1973, 0, 1, 'Film', '15', 'Blu-Ray');
CALL disks.create_disk('Die Hard - Die Hard', 'Die Hard 1', 'John McTieran', 1988, 0, 1, 'Film', '18', 'Blu-Ray');
CALL disks.create_disk('Die Hard - Die Hard 2', 'Die Hard 2', 'Renny Harlin', 1990, 0, 1, 'Film', '18', 'Blu-Ray');
CALL disks.create_disk('Die Hard - Die Hard with a Vengeance', 'Die Hard 3', 'John McTieran', 1995, 0, 1, 'Film', '15', 'Blu-Ray');
CALL disks.create_disk('Die Hard - Die Hard 4.0', 'Die Hard 4', 'Len Wiseman', 2007, 0, 1, 'Film', '15', 'Blu-Ray');
...
CALL disks.create_disk('Family Guy - It''s a Trap', 'Family Guy - It''s a Trap', 'Dominic Polcino, Peter Shin', 2010, 0, 2, 'Film', '15', 'DVD');
CALL disks.create_disk('Family Guy - Something Something Something Dark Side', 'Family Guy - Something Something Something Dark Side', 'Dominic Polcino, Peter Shin', 2009, 0, 2, 'Film', '15', 'DVD');
CALL disks.create_disk('Father Ted - The Complete Box Set', 'Father Ted - The Complete Box Set', 'Declan Lowney, Graham Linehan', 1999, 0, 5, 'TV Series', '15', 'DVD');
CALL disks.create_disk('Fight Club', 'Fight Club', 'David Fincher', 1999, 0, 2, 'Film', '18', 'DVD');
CALL disks.create_disk('Finding Nino', 'Finding Nino', 'Andrew Stanton', 2003, 0, 2, 'Film', 'U', 'DVD');
CALL disks.create_disk('A Fish Called Wanda', 'Fish Called Wanda', 'Charles Crichton', 1988, 0, 1, 'Film', '15', 'Blu-Ray');
CALL disks.create_disk('Four Weddings and a Funeral', 'Four Weddings and a Funeral', 'Mike Newell', 1994, 0, 1, 'Film', '15', 'DVD');
CALL disks.create_disk('Gladiator', 'Gladiator', 'Ridley Scott', 2000, 0, 2, 'Film', '15', 'DVD');
CALL disks.create_disk('Terry Pratchett''s Going Postal', 'Going Postal', 'Jon Jones', 2010, 0, 1, 'TV Adaptation', '12', 'DVD');
CALL disks.create_disk('Goodfellas', 'Goodfellas', 'Martin Scorsese', 1990, 0, 1, 'Film', '18', 'DVD');
CALL disks.create_disk('The Hangover', 'Hangover', 'Todd Phillips', 2009, 0, 1, 'Film', '18', 'Blu-Ray');
CALL disks.create_disk('The Hangover - Part II', 'Hangover 2', 'Todd Phillips', 2011, 0, 1, 'Film', '15', 'Blu-Ray');
CALL disks.create_disk('The Hangover - Part III', 'Hangover 3', 'Todd Phillips', 2013, 0, 1, 'Film', '15', 'Blu-Ray');
CALL disks.create_disk('Hannibal', 'Hannibal', 'Ridley Scott', 2001, 0, 1, 'Film', '18', 'DVD');
CALL disks.create_disk('Harry Potter and the Sorcerer''s Stone', 'Harry Potter 1', 'Chris Columbus', 2001, 0, 2, 'Film', 'PG', 'DVD');
CALL disks.create_disk('Harry Potter and the Chamber of Secrets', 'Harry Potter 2', 'Chris Columbus', 2002, 0, 2, 'Film', 'PG', 'DVD');
CALL disks.create_disk('Harry Potter and the Prisoner of Azkaban',  'Harry Potter 3','Alfonso Cuarón', 2004, 0, 2, 'Film', 'PG', 'DVD');
CALL disks.create_disk('Harry Potter and the Goblet of Fire',  'Harry Potter 4', 'Mike Newell', 2005, 0, 2, 'Film', '12', 'DVD');
CALL disks.create_disk('Harry Potter and the Order of the Phoenix',  'Harry Potter 5','David Yates', 2007, 0, 1, 'Film', '12', 'Blu-Ray');
CALL disks.create_disk('Highlander', 'Highlander', 'Russell Mulcahy', 1986, 0, 1, 'Film', '15', 'DVD');
CALL disks.create_disk('The Hobbit: An Unexpected Journey', 'Hobbit 1', 'Peter Jackson', 2012, 0, 2, 'Film', '12', 'Blu-Ray');
CALL disks.create_disk('The Hobbit: The Desolation Of Smaug', 'Hobbit 2', 'Peter Jackson', 2013, 0, 2, 'Film', '12', 'Blu-Ray');
CALL disks.create_disk('The Hobbit: The Battle Of The Five Armies', 'Hobbit 3', 'Peter Jackson', 2014, 0, 2, 'Film', '12', 'Blu-Ray');
CALL disks.create_disk('Terry Pratchett''s Hogfather', 'Hogfather', 'Vadim Jean', 2006, 0, 1, 'TV Adaptation', 'PG', 'DVD');
CALL disks.create_disk('Inception', 'Inception', 'Christopher Nolan', 2010, 0, 1, 'Film', '12', 'DVD');
